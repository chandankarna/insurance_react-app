        ...
        <>
            <div className="footerPageContainer">
                <div className="error-background">
                    <div className="error-ground"></div>
                    <div className="error-container">
                        <div className="error-left-section">
                            <div className="error-inner-content">
                                <h1 className="error-heading">
                                    4<span className="animated-text">0</span>4
                                </h1>
                                <p className="error-subheading">
                                    Oops! It seems like the page you were looking for{" "}
                                    <span className="animated-text">is missing.</span>
                                </p>
                                <div className="links">
                                    <a href="/">Go Home</a>
